...
|`src/functions.json`| Defines the AI functions/tools that the agent can call to interact with external APIs.|
|`src/handlers.py`| Implements the function handlers that process API calls and render responses as adaptive cards.|
