...
export interface SetSensitivityLabelInputs extends Inputs {
  /** @description Select declarativeAgent.json file */
  "declarative-agent-manifest-path"?: string;
  /** @description Select a sensitivity label */
